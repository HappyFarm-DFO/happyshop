...
contract IncrementalSellerModule {
    
    address public vault;
    ItemsGifterDB public gifter;
    uint public eth_percent_price=10;
    ...
    function buy() payable public returns(bool){
        require(gifter.gift(gift,msg.value*(eth_percent_price++)/100,msg.sender));
