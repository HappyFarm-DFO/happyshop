...
contract GifterModule {
    
    ItemsGifterDB public gifter=ItemsGifterDB(0xC9746af16e5d5cc414eDF53f91cBA76e6Eaf739D);
    
    function buy() payable public returns(bool){
        require(gifter.gift(0x801F90f81786dC72B4b9d51Ab613fbe99e5E4cCD,1,msg.sender));
        return true;
    } 
